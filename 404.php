    ...
    <section class="text-center">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <h2><?php echo _x('Erreur de chargement de la page', 'Titre page erreur 404', 'telecredit') ?></h2>
          <div class="content-wrapper">
            <?php echo _x('La page à laquelle vous tentez d’accéder n’existe pas.', 'Texte page erreur 404', 'telecredit') ?>
          </div>
        </div>
      </div>
    </section>
